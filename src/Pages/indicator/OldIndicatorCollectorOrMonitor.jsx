  ...
  getCollectorIndicators = (
    ...
    this.props
      .dispatch(
        userActions.API(
          "get",
          `v2/get_collector_indicators?year=${
            this.props.globalStorage.year
          }&page=${page}&per=${this.state.per_page}${query || ""}${
                  ...
                  <div className="mt-5 card text-center borderDarkpurple ">
                    <div className="card-body">
                      <p className="card-title Darkpurple ">
                        <small className="Darkpurple lalezar">
                          {" "}
                          کل شاخص ها
                        </small>
                      </p>
                ...
                <table className="indicator-tbl">
                  <thead>
                    <tr className="indicator-tr">
                      ...
                      <th className="indicator-th">واحـد متـولی</th>
                      <th className="indicator-th">تارگت</th>
                      <th className="indicator-th">عملیـات</th>
                    </tr>
                  </thead>
                  <tbody>
                    {indicator_loading && (
                  ...
                  <>
                    <div className="Cource  indicator_detail pwa_styles_indicator">
                      ...
                      <div className="container-fluid headerIndeicator">
                        <div
                          className={
                            "row d-flex justify-content-around   my-4 "
                          }
                        >
                        ...
                        <div className="row d-flex justify-content-center  ">
                          {indicator.creation_date && (
                            <div className={"col-lg-3 mt-4 "}>
                              ...
                              <div className="rounded-pill py-2 datediv d-flex justify-content-around align-items-center">
                        ...
                        >
                          {indicator.quality_dimension && (
                            <div className="col-xl-3 col-lg-3 col-md-6  my-3 ">
                              <div className="text-center bg-pink rounded-pill py-2 text-white ">
...
const OldIndicatorCollectorOrMonitor = connect((state) => ({
  globalStorage: state.globalStorage,
}))(IndicatorCollectorOrMonitor);
export { OldIndicatorCollectorOrMonitor };
