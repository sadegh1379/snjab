...
import login_doc from "../assets/images/crmm.png";
...
class PublicChecklist extends Component {
  ...
  getChecklists = (page = 1) => {
    ...
    this.props
      .dispatch(
        userActions.API(
          "get",
          `/v1/public_checklists_with_cert?hospital_id=${hospital}&year=${year}&page=${page}&per=48`
        )
      )
      .then(res => {
        this.setState({
  ...
  render() {
    ...
    return (
      <div className="w-100 bg-drr py-5 container-fluid" style={{ minHeight: "100vh" }}>
        <img src={login_doc} alt="نظـرسنجـی" className="d-block mx-auto" width={120}/>
        <h2 className="text-center text-primary h5 mt-4">فــرم هـای نظـرسنجـی </h2>
