  ...
  componentDidMount() {
    ...
    if (isCollector) {
      ...
      if (!this.props.globalStorage.indicators.length) {
        this.props.dispatch(
          userActions.getIndicator(this.props.globalStorage.year, true, this.props.globalStorage.me.id)
        );
      }
    }
    //  else {
        ...
        <div className="container-fluid pb-5">
          <div className="" style={{ textAlign: "center", paddingTop: "42px" }}>
            <div>
              ...
              >
                نمـای کلـی تمامـی شـاخص هـای بیمـارستـان شمـا
              </h2>
            </div>
