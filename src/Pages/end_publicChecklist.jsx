...
class PublicChecklist extends Component {
  ...
  simulateonChange() {
    ...
    // const auto = params.get('auto');
    // const idd = params.get('_id');
    // console.log("autooooA"+auto);
    // console.log("idddddA"+idd);
    if(checks.default.hide){
  ...
  checkIDOFListCheckList = () => {
    setTimeout(() => {  
      console.log("sleep5");
      // document.getElementById("section_remove_dowgani").style="display:none";
   }, 200);
    // var link = document.getElementById('60d3056d366a162d57805282');
    // link.click();
  }
