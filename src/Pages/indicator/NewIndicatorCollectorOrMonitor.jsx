    ...
    return (
      <>
        ...
        <div className="container-fluid pb-5">
          <div className="" style={{textAlign: 'center',paddingTop: '42px'}}>
            <div>
              <h2
                style={{
                  color: "#333",
              ...
              >
               شاخص هایـی کـه شمـا اندازه گیـری می نمـاییـد
              </h2>
            </div>
                  ...
                  <>
                    <div className="Cource  indicator_detail pwa_styles_indicator">
                      ...
                      <div className=" headerIndeicator">
                        <div className="text-center  " style={{background:'#104c82',color:'#ffffff',padding: '15px',
                          borderTopRightRadius: '20px',borderTopLeftRadius: '20px',fontSize:'13px',fontFamily:'iransansbold'}}>
                           مشاهده شناسنامه شاخص با عنوان {indicator.title}  (کد -  {indicator.code} )
                        </div>
                      ...
                      <div className="container-fluid shadow   py-5  bg-white">
                        <div className="row d-flex justify-content-center  ">
                          {indicator.creation_date && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>تاریخ تدوین</span>
                                <div className=" bg-dark text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.edit_date && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>تاریخ بازنگری</span>
                                <div className=" bg-dark text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                        ...
                        >
                          {indicator.quality_dimension && (
                            <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                              <span className="" style={{fontFamily:'iransansBold'}}>بعـد کیفیت</span>
                              <div className=" bg-pink   text-white " style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.report_type && (
                            <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                              <span className="" style={{fontFamily:'iransansBold'}}>نحـوه گزارش</span>
                              <div className=" bg-warning text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.source && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>منبـع شاخص</span>
                                <div className=" bg-success text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.measurement_unit && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>واحـد انـدازه گیـری</span>
                                <div className=" bg-light-blue text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.desirability && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>مطلـوبیت شاخص</span>
                                <div className=" bg-danger text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.basis && (
                              ...
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>مبنـا شاخص</span>
                                <div className=" bg-purple text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.aspect && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>جنبـه شاخص</span>
                                <div className=" bg-purple text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                          ...
                          {indicator.indicator_type && (
                              <div className="col-xl-3 col-lg-3 col-md-6  my-3 " style={{textAlign: 'right',fontSize: '13px'}}>
                                <span className="" style={{fontFamily:'iransansBold'}}>نـوع شاخص</span>
                                <div className=" bg-purple text-white" style={{marginTop: '10px',borderRadius: '10px',fontSize:'13px' ,textAlign: 'center',padding:'10px'}}>
                        ...
                        <div className={"row  "}>
                          {indicator.definition && (
                            ...
                            >
                              <label htmlFor="" className="rounded-pill  px-4  titleInput bg-white" style={{fontSize:'13px',fontFamily:'iransansBold',padding:'10px'}}>
                                تعـریف شـاخص و اهمیت موضـوع
                              </label>
                              <div className=" box-border " style={{borderRadius:'20px'}}>
                                {indicator.definition.map((item, index) => {
                                  return (
                                    <p
                                      style={{ textAlign: "justify",fontSize:'12px',lineHeight:'2em' }}
                                      key={index}
                                      className="p-10 "
                                    >
                                      {item}
                        ...
                        <div className="row justify-content-center">
                          <div className="calculation d-flex flex-wrap flex-column col-lg-8 align-items-center py-5 my-5 mx-auto" style={{borderRadius:'20px'}}>
                            <div className="row justify-content-end w-100">
                              <ContentEditable
                                ...
                                className="rounded-pill col-6 bg-white shadow-sm d-flex flex-wrap align-items-center justify-content-center py-2 pwa_test_compute" style={{border: '1px solid #b0b0b0',fontSize:'13px'}}
                                tagName="div"
                              />
                            ...
                            <div className="row align-items-center justify-content-center w-100 pl-sm-5">
                              <input
                                type="text"
                                className="rounded-pill  py-2 col-2 shadow-sm text-center" style={{border: '1px solid #b0b0b0',fontSize:'13px'}}
                                name="multiplier"
                                readOnly={true}
