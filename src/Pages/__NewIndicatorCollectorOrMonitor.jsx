...
import moreIcon from '../../assets/images/checklistt.png'
import excelPic from '../../assets/images/excel.png'
import loadingGif from '../../assets/images/loading.gif'
import {CalendarInterval} from "../../_components/CalendarInterval";
import {HospitalTable, IndicatorCalenderComp, Routes, Chart, Pagination,} from "../../_components";
...
export class IndicatorCollectorOrMonitor extends Component {
    ...
    exportExcel = () => {
        ...
        dispatch(userActions.API('get', `v2/indicator/user_indicators_excel?year=${this.props.globalStorage.year}`, null, false))
            .then(res => {
                if (res.status === 200) {
                    this.interval.current = setInterval(() => {
                        dispatch(userActions.API('get', res.data.url, null, false, false))
                            .then(response => {
    ...
    render() {
        ...
        const newWards = [{ name: 'همه بخش های بیمارستان', _id: '' }, ...this.props.globalStorage.wards];
            ...
            <>
                ...
                <div className="container-fluid pb-5">
                    <div className="indicator-RightTitle">
                        <div>
                            <h2 style={{ color: '#333', fontFamily: 'iransansBold', marginRight: '20px',fontSize:'20px' }}>شـاخص</h2>
                        </div>
                            ...
                            <div className="indicator-kol" >
                                ...
                                <div className="indicator-topnav" >
                                    ...
                                    <a
                                        ...
                                        className="indicator-active mr-2" href="#home">فیلتـر بر اسـاس (بخش / واحـد متولـی)</a>
                                ...
                                <table className="indicator-tbl">
                                    <thead>
                                        <tr className="indicator-tr" >
                                            <th className="indicator-th"style={{width:'5%'}} >ردیف</th>
                                            <th className="indicator-th" style={{width:'25%'}}>عنـوان</th>
                                            <th className="indicator-th" style={{width:'10%'}}>واحـد متـولی</th>
                                            <th className="indicator-th" style={{width:'5%'}}>تارگت</th>
                                            <th className="indicator-th" style={{width:'5%'}}>عملیـات</th>
                                            <th className="indicator-th" style={{width:'50%'}}>اندازه گیری (بر اساس دوره تناوب)</th>
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            indicators.length && !indicator_loading ? indicators.map((row, i) => {
                                                ...
                                                return (
                                                    <tr className="animated fadeIn" key={i} >
                                                        ...
                                                        <td className={class_name} style={{width:'25%'}} >
                                                            {isCollector ? row.title : row.indicator.title}
                                                        </td>
                                                        <td className={class_name} style={{width:'10%'}}>
                                                        ...
                                                        <td className={class_name} style={{width:'5%'}}>
                                                            <img
                                                                ...
                                                                title="جزییات" style={{ width: '50px', cursor: 'pointer' }} src={moreIcon} alt="عملیات" />
                                                        </td>
                                                        {/*اندازه گیری */}
                                                        <td className={class_name} style={{width:'50%'}}>
                                                            <div className="col-lg-12 bg-white" >
                                                                <div className="card-deck mt-4 pb-4 d-flex justify-content-center" style={{minHeight: '200px'}}>
                                                                    {this.state.intervals
                                                                        .filter(i => !this.state.filter || i.colorTheme === this.state.filter)
                                                                        .map((c, i) => c.component)
                                                                    }
                                                                </div>
                                ...
                                <div className="w-100 d-flex justify-content-end pl-4">
                                    {indicators.length ? (
                                        ...
                                        totalPage={Math.ceil(total_indicators / per_page)}
                                        active={page}
                                        callBack={isCollector ? this.getCollectorIndicators : this.getMonitorIndicators}
                                        />
                                    ):<></>}
